...
public class formbeli extends javax.swing.JFrame {
   ...
   public final void loadData() {
    ...
    private void tampilpilih() {
        try {
            ...
            while (r.next()) {
                pilihbuku.addItem(r.getString("nama_barang"));
            }
  ...
  private void nofaktur() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(kdbuku, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 160, 120, 30));

        pilihbuku.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "buku cerita", "buku gambar", "buku prono 18+", " ", " ", " " }));
        pilihbuku.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pilihbukuActionPerformed(evt);
            }
        });
        jPanel1.add(pilihbuku, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 130, 30));
    ...
    private void pilihbukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pilihbukuActionPerformed
        // TODO add your handling code here:
         if (pilihbuku.getSelectedItem().equals("pilih barang")){
            kdbuku.setText("");
            hsatuan.setText("");
        }else{
        try {
            ...
            String sql = "SELECT kd_barang, jumlah_barang FROM tbl_barang WHERE nama_barang ='" + pilihbuku.getSelectedItem() + "'";
            ResultSet r = s.executeQuery(sql);

            while (r.next()) {
                
                kdbuku.setText(r.getString("kd_barang"));
        ...
        try {
            ...
            String sql = "SELECT harga_jual FROM tbl_barang WHERE nama_barang ='" + pilihbuku.getSelectedItem() + "'";
            ResultSet r = s.executeQuery(sql);
    ...
    private void hitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hitungActionPerformed
        // TODO add your handling code here:
         if(faktur.getText().equals("") ||kdbuku.getText().equals("") || pilihbuku.getSelectedItem().equals("")|| hsatuan.getText().equals("")|| tjumlah.getText().equals("")){
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        ...
        if(faktur.getText().equals("") ||kdbuku.getText().equals("") || pilihbuku.getSelectedItem().equals("")|| hsatuan.getText().equals("")|| tjumlah.getText().equals("")|| ttotal.getText().equals("")){
            JOptionPane.showMessageDialog(null, "LENGKAPI DATA !", "elektronik berkah", JOptionPane.INFORMATION_MESSAGE);
        
        }else{
            String kdbarangg = kdbuku.getText();
            String pilihbarangg = (String)pilihbuku.getSelectedItem();
